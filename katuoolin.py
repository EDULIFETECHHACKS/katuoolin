...
\__|  \__| \_______|   \____/|\_____/|  \______/  \______/ \__|\__|\__|  \__| V2.0\033[1;m
 ...
 \033[1;32m+ -- -- +=[ editor: EDULIFETECHHACKS | Homepage: https://github.com/edulifetechhacks/katuoolin.git\033[1;m
...
4) View the contents of sources.list file
					...
					if repo == "1":
						...
						delete_list = ["# Kali linux repositories | Added by katuoolin\n", "deb http://http.kali.org/kali kali-rolling main contrib non-free\n"]
						fin = open(infile)
